...
export default connect(null, {borrarProducto}) (Producto); //como la acción de borrar un producto no agrega nada al state, el argumento "mapStateToProps" dentro de connect() será null